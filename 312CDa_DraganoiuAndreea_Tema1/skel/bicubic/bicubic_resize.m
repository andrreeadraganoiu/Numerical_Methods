function R = bicubic_resize(I, p, q)
    ...
    for y = 0 : p - 1
        for x = 0 : q - 1
            ...
            initial_coords = T_inv * [x, y, 1]';
            x_p = initial_coords(2);
            y_p = initial_coords(1);
            ...
            A = bicubic_coef(I', Iy', Ix', Ixy', x1, y1, x2, y2);
            ...
            x_final = [1, x_p, x_p ^ 2, x_p ^ 3];
            y_final = [1; y_p; y_p ^ 2; y_p ^ 3];
            
            R(y + 1, x + 1) = x_final * A * y_final;
